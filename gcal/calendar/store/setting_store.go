...
/*
func DefaultReminderTimingForUser () *ReminderTiming {
	return &DailySummaryUserSettings{
		PostTime: "8:00AM",
...
func (s *pluginStore) updateReminderTimingForUser(user *User, value interface{}) error {
	if user.Settings.ReminderTiming == nil {
		user.Settings.DailySummary = DefaultDailySummaryUserSettings()
	}
